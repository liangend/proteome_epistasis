...
04_sim_snp_inter_sand.R: Simulation of interaction P value at the SNP level calculated by SVE

05_sim_prot_inter.R: Simulation of interaction P value at the protein level
...
10_ukb_pwas.R: Regular and epistasis-adjusted PWAS on UKB traits
