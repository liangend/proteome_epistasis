...
p_trans = fread('cis_trans_inter/02_cis_cvgp_inter/trans_p_all.txt', header = T)
p_inter = fread('cis_trans_inter/02_cis_cvgp_inter/inter_p_all.txt', header = T)
